...
class DeleteScheduledQueryCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteScheduledQueryRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_json1_0_1.serializeAws_json1_0DeleteScheduledQueryCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_0_1.deserializeAws_json1_0DeleteScheduledQueryCommand)(output, context);
    }
}
